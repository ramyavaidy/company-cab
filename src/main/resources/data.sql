...
insert into droppoint_distance values(0,'target_headquarter','target_headquarter');
insert into droppoint_distance values(0,'pointA','pointA');
insert into droppoint_distance values(0,'pointB','pointB');
